...
function addToFilterTable(graph, userID, datasetID, overrideArray, callback){
	...
	else var KeysToSave = ['mergedNodes', 'sameProfileHas', 'sameNodeHas', 'subsetProfiles', 'usedLoci', 'nodes', 'goeburstprofilesize', 'missingsInfo', 'distanceMatrix', 'goeBURSTschemeGenesExport', 'goeburst_timer', 'parent_id', 'analysis_method', 'missing_threshold'];
