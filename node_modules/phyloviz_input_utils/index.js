...
function FlushFunction(graphInput, res, callback){
	...
	//res.setMaxListeners(0); //set listerners to infinity
		...
		function runFlush(index){
			...
			else if(arrayOfKeys[index] == 'mergedNodes' || arrayOfKeys[index] == 'sameNodeHas' || arrayOfKeys[index] == 'indexesToRemove'){
			...
			else if(arrayOfKeys[index] == 'distanceMatrix' || arrayOfKeys[index] == 'usedLoci'){
				index += 1;
				runFlush(index);
			}
