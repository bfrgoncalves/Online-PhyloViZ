		...
		function runFlush(index){
			...
			if(arrayOfKeys[index] == 'nodes' || arrayOfKeys[index] == 'subsetProfiles' || arrayOfKeys[index] == 'links' || arrayOfKeys[index] == 'distanceMatrix'){
				if(graphInput[arrayOfKeys[index]].length != 0){
					...
					if (arrayOfKeys[index] == 'distanceMatrix' && nodeLength > 3000) var tout = 100;
					else if (arrayOfKeys[index] == 'distanceMatrix' && nodeLength > 1000) var tout = 50;
					else if (arrayOfKeys[index] == 'distanceMatrix' && nodeLength > 30) var tout = 10;
					else var tout = 1;
