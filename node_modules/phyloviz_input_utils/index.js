		...
		function runFlush(index){
			...
			if(arrayOfKeys[index] == 'nodes' || arrayOfKeys[index] == 'subsetProfiles' || arrayOfKeys[index] == 'links' || arrayOfKeys[index] == 'distanceMatrix'){
				if(graphInput[arrayOfKeys[index]].length != 0){
					...
					/*
					else if (arrayOfKeys[index] == 'distanceMatrix' && nodeSlice[0].length > 6000) var tout = 600;
					else if (arrayOfKeys[index] == 'distanceMatrix' && nodeSlice[0].length > 5000) var tout = 500;
					else if (arrayOfKeys[index] == 'distanceMatrix' && nodeSlice[0].length > 4000) var tout = 400;
					else if (arrayOfKeys[index] == 'distanceMatrix' && nodeSlice[0].length > 3000) var tout = 300;
					else if (arrayOfKeys[index] == 'distanceMatrix' && nodeSlice[0].length > 2000) var tout = 200;
					else if (arrayOfKeys[index] == 'distanceMatrix' && nodeSlice[0].length < 2000) var tout = 100;
					*/
					else var tout = 5;
